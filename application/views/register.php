                            ...
                            <div class="col-md-12">
                                <div class="col-md-6">
                                    <div class="form-group" ng-class="{'has-error':submitted && regForm.access_level.$invalid}">
                                        <select id="FeatureTypeDropdown" name="access_level" class="form-control" ng-model="access_level" ng-options="ft as ft.access_name for ft in accessLevel" required>
